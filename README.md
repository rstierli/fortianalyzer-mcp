...
[![Version](https://img.shields.io/github/v/release/rstierli/fortianalyzer-mcp?label=version&color=green)](CHANGELOG.md)
...
see "Skills Layer" below). The 2.12.0 release consolidated thirteen tools into
